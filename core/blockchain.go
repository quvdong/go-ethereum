...
func (bc *BlockChain) WriteDirtyDump(dump *state.DirtyDump) error {
	return WriteDirtyDump(bc.db, dump)
}

// GetDirtyDump gets the dirty dump
func (bc *BlockChain) GetDirtyDump(root common.Hash) (*state.DirtyDump, error) {
	return GetDirtyDump(bc.db, root)
}
